...
#   template {
#     spec {
#       #    container_concurrency = try(each.value.container_concurrency), var.global_microservices_container_concurrency)
#       container_concurrency = var.min_instances
#       containers {
#         #image = "us-docker.pkg.dev/cloudrun/container/hello"
#         image = "europe-west3-docker.pkg.dev/dgcp-sandbox-lalit-sharma/my-artifact-registry/my-nginx"
#         env {
#           name  = "_SERVICE_NAME"
...
#               key  = data.google_secret_manager_secret_version.my_secret.version
#             }
#           }
#         }
#         ports {
...
#         }
#       }
#       service_account_name = "cloudbuild@dgcp-sandbox-lalit-sharma.iam.gserviceaccount.com"
#       volumes {
#         name = data.google_secret_manager_secret_version.my_secret.secret
#         secret {
#           secret_name = data.google_secret_manager_secret_version.my_secret.secret
#           items {
#             key  = data.google_secret_manager_secret_version.my_secret.version
#             path = "shared"
#           }
